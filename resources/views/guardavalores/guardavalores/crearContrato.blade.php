...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4 text-center">Asignar Contrato</h1>
    
    <form class="bg-white border border-gray-300 shadow-lg rounded-md mx-auto max-w-3xl px-8 pt-6 pb-8 mb-4" action="{{ route('contratoGuardar') }}" method="POST">
    ...
    <div class="grid grid-cols-3 gap-4 mb-4">
        <div class="col-span-1">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="nombre_contrato">
                Nombre de contrato
            </label>
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nombre_contrato" type="text" name="nombre_contrato" placeholder="Nombre de contrato" required>
        </div>
        <div class="col-span-1">
