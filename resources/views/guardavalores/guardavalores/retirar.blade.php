...
<div class="container mx-auto p-4 grid gap-4">
    ...
    <h1 class="text-2xl font-bold mb-4 text-center md:text-left">Retirando {{$expediente->nombre}}</h1>
        ...
        <form id="formFinger" class="bg-white border border-gray-300 shadow-lg rounded-md mx-auto max-w-screen-md px-8 pt-8 pb-8 mb-8" action="{{route('almacenarActividadGV')}}" method="POST">
