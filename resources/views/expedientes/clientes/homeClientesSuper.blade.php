...
@if(count($elementos) > 0)
    ...
    @foreach($elementos as $elemento)
        ...
        @if(!empty($elemento->id_consecutivo) && !empty($elemento->id_clienteGiro) && $elemento->id_consecutivo !== 0 && $elemento->id_consecutivo !== null)
        ...
        @else
            <td class="px-6 py-4 whitespace-nowrap dark:text-white">
                ...
                <td class="px-6 py-4 whitespace-nowrap dark:text-white">
                @if(!empty($elemento->id_clienteGiro) && $elemento->id_clienteGiro != 0)
                {{$elemento->id_clienteGiro}}
                @else
                NA
                @endif
