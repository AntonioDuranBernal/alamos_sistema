...
<form action="{{ route('ejecutarExpedienteUsuarioSU') }}" method="POST" class="mb-4">
    @csrf
    ...
    @endforeach
        ...
        <div class="flex justify-center gap-4">
            ...
            <a href="{{ route('exportarExpedientesR3', ['elementos' => $elementos]) }}" class="mt-5 bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-lg text-sm py-2 px-4">Exportar</a>
    @else
...
<td class="px-6 py-4 whitespace-nowrap dark:text-white {{ $elemento->estado === 'Devolución atrasada' ? 'text-red-500 font-bold' : '' }}">
    {{ $elemento->estado }}
</td>
