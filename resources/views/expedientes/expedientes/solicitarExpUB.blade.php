...
<div class="container mx-auto p-4 grid gap-4">
    ...
    <h1 class="text-2xl font-bold mb-4 text-center md:text-left">{{$expediente->nombre}}</h1>
        ...
        <form id="formFinger" class="bg-white border border-gray-300 shadow-lg rounded-md mx-auto max-w-screen-md px-8 pt-8 pb-8 mb-8" action="{{route('almacenarActividadUsuarioBasico')}}" method="POST">
    ...
    <textarea id="motivo" name="motivo" placeholder="Ingresa el motivo de tu solicitud" class="w-full p-2 border border-gray-300 rounded" required maxlength="250"></textarea>
        ...
        <div class="flex justify-center items-center space-x-4 mt-6">
            ...
            <button type="button" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Confirmar con huella</button>
          </div>
